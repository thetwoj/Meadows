	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		events.AddConditionsUpdatedListener(new ConditionsListener(){
			public void EventFired(ConditionsUpdated event)
			{
				...
				// If the loading message is showing, dismiss it
				if(loading.isShowing()) loading.dismiss();
			}
		});

		// Display loading message to let user know the page is loading
		loading = ProgressDialog.show(this, "", "Loading conditions, please wait...", true);
		// Request conditions to populate the page with
